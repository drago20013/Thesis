...
reg [15:0] current_counter, next_counter;
...
assign quarter_tick = divider;
assign half_tick = {quarter_tick[14:0], 1'b0};
//half_tick = 2 * quarter_tick
...
always @(*) begin
    ...
    case (current_state)
        ...
        STATE_START_1: begin
            next_sda = 1'b0;
            if(current_counter == half_tick) begin
                next_counter = 16'b0;
                next_state = STATE_START_2;
            end
        end
        STATE_START_2: begin
            next_sda = 1'b0;
        ...
        STATE_HOLD: begin
            ...
            if(activate) begin
                ...
                case (command)
                    COMMAND_REPEAT_START, COMMAND_START: begin
                        next_state = STATE_REPEAT_START;
                    end
                    COMMAND_STOP: begin
        ...
        STATE_DATA_1: begin
            ...
            next_scl = 1'b0;
            data_phase = 1'b1;
            if(current_counter == quarter_tick) begin
                next_counter = 16'b0;
                next_state = STATE_DATA_2;
            end
        end
        STATE_DATA_2: begin
            next_sda = current_transmit[8];
